                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-white/5 bg-[#0A0A0A]">
                                <th className="px-6 py-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">Nro. Guía</th>
                                <th className="px-6 py-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">Origen / Destino</th>
                                <th className="px-6 py-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">Remitente</th>
                                <th className="px-6 py-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">Consignatario</th>
                                <th className="px-6 py-4 text-xs font-semibold text-gray-400 uppercase tracking-wider text-center">Piezas</th>
                                <th className="px-6 py-4 text-xs font-semibold text-gray-400 uppercase tracking-wider text-center">Peso</th>
                                <th className="px-6 py-4 text-xs font-semibold text-gray-400 uppercase tracking-wider text-center">Creado</th>
                                <th className="px-6 py-4 text-xs font-semibold text-gray-400 uppercase tracking-wider text-center">Confianza</th>
                                <th className="px-6 py-4 text-xs font-semibold text-gray-400 uppercase tracking-wider text-center">Ciclo de Vida</th>
                            ...
                            {loading ? (
                                ...
                                documents.map((doc, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 max-w-[180px] truncate text-sm text-gray-400" title={doc.nombreRemitente}>
                                            {doc.nombreRemitente}
                                        </td>

                                        <td className="px-6 py-4 max-w-[180px] truncate text-sm text-gray-400" title={doc.nombreConsignatario}>
                                        ...
                                        <td className="px-6 py-4 text-center text-sm text-gray-400">
                                            {doc.pesoBruto} <span className="text-xs text-gray-600">{doc.unidadPesoCodigo}</span>
                                        </td>
